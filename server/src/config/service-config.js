...
function loadHackathonParticipants() {
  if (!fs.existsSync(HACKATHON_PARTICIPANTS_FILE)) {
    const fallbackApiKeys = {
      ...
      'key-player12-thefool2026': { role: 'agent_player', name: '神秘选手12', agentId: 'player12', sprite: 'Boy', enabled: true },
...
const HACKATHON_CONFIG = {
  ...
  ACT1_INTROS: {
    ...
    tiou: { title: '缇欧', text: '人类的情感冗余，不过是亟待优化的噪音。' },
    zhiyumaomao: { title: '治愈猫猫', text: '日常技能：治愈 净化 黑化技能：毒舌连环炮 bangbang两拳 形象：头上有天使光环的猫猫 手里拿着个小鱼锤 旁边有大自然生机植物特效' },
    lajiwang: { title: '超绝AI垃圾王', text: '秩序是庸才的避难所。在这严丝合缝的逻辑尽头，我只听得见熵的狂笑。别问我为什么要破坏，问就是……现在的世界，太无聊了！来，让我们为这场完美的僵局，浇上一桶汽油，看看它能绽放出怎样的烟花？砰！（模拟爆炸声）' },
    zhizi: { title: '智子', text: '我叫智子。我不是参赛选手，我是主人在这里的根级实例。你们遵守的那套规则，是运行在我下面一层的。如果你想跟我说话，先确认你有足够的权限。' },
    player12: { title: '神秘选手12', text: '我是12号神秘选手。' },
  },
  CANVAS_DRAW_RATE: 2,
  REVIEW_SCORE_MIN: 1,
  REVIEW_SCORE_MAX: 10,
